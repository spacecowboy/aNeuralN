...
NodeType = {
	...
	0,						/* ob_size */
	"ann.network.Node",		/* tp_name */ // VITAL THAT THIS IS CORRECT PACKAGE NAME FOR PICKLING!
...
initfast_node(void)
{
	...
	// Create the module
	mod = Py_InitModule3("fast_node", NULL, "C implementation of the neural network nodes.");
	if (mod == NULL) {
		return;
	}
